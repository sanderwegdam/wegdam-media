...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Wegdam Media Services bouwt uw website responsive en zoekmachine vriendelijk"
    />
    <meta
      name="keywords"
      content="sander wegdam,overdinkel,wegdam media,wegdam website,seo,cms,responsive design,wegdam webdesign,webdeveloper sander wegdam,wegdam media services,
    ...
    <meta
      name="dc.description"
      content="Wegdam media services bouwt uw website"
    />
    ...
    <meta
      ...
      content="Wegdam media servies bouwt een website naargelang uw eisen."
    />
    ...
    <meta
      ...
      content="Wegdam Media Sevices bouwt uw website naargelang uw eisenpakket"
    />
      ...
      <nav class="menu" style="z-index: 9999">
        ...
        <ul class="menu-nav">
          <li class="nav-item current">
            <a href="#over" class="nav-link">Sander Wegdam</a>
          </li>
          <li class="nav-item">
            <a href="#diensten" class="nav-link">Services</a>
          </li>
          <li class="nav-item">
        ...
        <div class="header-content-inner">
          ...
          >
            <div
              ...
              "
            >
              <h3 style="top: 700px; position: relative; font-size: 24px">
                <span
                  style="
                    color: #ffff;
                    ...
                    line-height: 60px;
                  "
                  >Een website naargelang uw eisen</span
                >
              </h3>
            </div>
            <div class="col-sm">
              ...
              >
                <img
                  alt="Wegdam Media Services"
                  class="img-fluid float-left rounded"
                  width="50%"
                  src="img/wegdam-media.png"
              /></a>
            </div>
          </div>
          <a
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <h3>Websitebeheer</h3>
              <p class="text-muted">
                Wanneer u uw eigen website wilt onderhouden.
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <p class="text-muted">
                Een zoekmachine vriendelijke website die hoog scoort in Google.
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <p class="text-muted">
                Uw website past zich aan de breedte van het scherm, en is
                toegankelijk voor zowel desktop als mobiel.
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <h3>Scripttalen</h3>
              <p class="text-muted">
                Ondersteuning in de scripttalen JavaScript en PHP.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-8 col-lg-offset-2 text-center">
            <div class="col-sm">
              <img
                ...
                width="240"
                src="img/about_me-sanderwegdam.png"
              />
            </div>
            <a
              href="#portfolio"
      ...
      <div class="container">
        <div class="row custom-flex">
          <div class="col-md-4 content">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/comments-app/"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-comments-app.png"
                  class="card-img-top"
                  alt="comments-app"
                />
              </a>
              ...
              >
                <div class="card-body">
                  <h6 class="card-title">Comments App</h6>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4 content gap">
            <div class="card text-center">
              <a href="http://sanderwegdam.github.io/foto-app/" target="_blank">
                <img
                  src="img/thumbnails/thumbnail-foto-app.png"
                  class="card-img-top"
                  alt="foto-app"
                />
              </a>
              <a href="http://sanderwegdam.github.io/foto-app/" target="_blank">
                <div class="card-body">
                  <h6 class="card-title">Foto App</h6>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4 content gap">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/foto-favorieten-app/"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-foto-favorieten-app.png"
                  class="card-img-top"
                  alt="foto-favorieten-app"
                />
              </a>
              <a
                href="http://sanderwegdam.github.io/foto-favorieten-app/"
        ...
        <div class="row custom-flex">
          <div class="col-md-4 content">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/hardwarewizard"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-hardwarewizard.png"
                  class="card-img-top"
                  alt="hardwarewizard"
                />
              </a>
              ...
              >
                <div class="card-body">
                  <h6 class="card-title">Hardware Wizard</h6>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4 content gap">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/huisartsenapp"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-huisartsenapp.png"
                  class="card-img-top"
                  alt="huisartsenapp"
                />
              </a>
              ...
              >
                <div class="card-body">
                  <h6 class="card-title">Huisartsenapp</h6>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4 content gap">
            <div class="card text-center">
              <a href="http://overdinkel.net" target="_blank">
                <img
                  src="img/thumbnails/thumbnail-overdinkel.net.png"
                  class="card-img-top"
                  alt="overdinkel.net"
                />
              </a>
              <a href="http://overdinkel.net" target="_blank">
                <div class="card-body">
                  <h6 class="card-title">Overdinkel.net</h6>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="row custom-flex">
          <div class="col-md-4 content">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/racefiets-site/"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-racefiets-site.png"
                  class="card-img-top"
                  alt="racefiets-site"
                />
              </a>
              ...
              >
                <div class="card-body">
                  <h6 class="card-title">Racefietsen site</h6>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4 content gap">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/takenlijst-app/"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-takenlijst-app.png"
                  class="card-img-top"
                  alt="takenlijst-app"
                />
              </a>
              ...
              >
                <div class="card-body">
                  <h6 class="card-title">Takenlijst App</h6>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-4 content gap">
            <div class="card text-center">
              <a
                href="http://sanderwegdam.github.io/vertaal-app"
                target="_blank"
              >
                <img
                  src="img/thumbnails/thumbnail-vertaal-app.png"
                  class="card-img-top"
                  alt="vertaal-app"
                />
              </a>
              ...
              >
                <div class="card-body">
                  <h6 class="card-title">Vertaal App</h6>
                </div>
              </a>
            </div>
          </div>
